import {createContext, useMemo, useContext, useCallback, useEffect, JSX} from 'react'
...
type AuthContextType = {
    ...
    authenticate: (email: string, password: string, remember?: boolean) => Promise<void>
...
export const AuthContextProvider: ({children}: { children: JSX.Element }) => JSX.Element = ({ children }) => {

    const { data: user, mutate: refreshUser, isLoading: isUserLoading } = useSWR<Partial<UserResource>>([route('user.show', {include: 'workspaces'}), false])
